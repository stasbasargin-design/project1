(function () {
  ...
  async function uploadDefectFile(file, kind) {
    ...
    const clientEntryId = requestId();
    const response = await call1C('/defects/entries/add', orderPayload({ documentRef: sheet.documentRef, clientEntryId, entry: { clientEntryId, type: kind, file: payload } }));
